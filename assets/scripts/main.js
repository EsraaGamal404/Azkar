document.getElementById("switch").onclick = () => {
  if (document.body.classList.contains("dark-theme")) {
    ...
    document.getElementById("switch").src = "assets/icons/dark.webp";
  } else {
    document.body.classList.add("dark-theme");
    document.getElementById("switch").src = "assets/icons/light.webp";
  }
};
...
for (let i = 0; i < data["أذكار المساء"].length;i++) {
  evening += `
<li>
  <p><span>${data["أذكار المساء"][i].content}</span> <span class="number">(${data["أذكار المساء"][i].count})</span></p>
</li>`;
}
...
document.getElementById("remembrances-after-prayer").innerHTML = afterPrayer;
...
document.getElementById("prophets-list").innerHTML = prophetsSupplications;
});
